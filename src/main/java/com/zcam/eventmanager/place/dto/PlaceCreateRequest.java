...
@Schema(description = "Request used to create a new place")
public record PlaceCreateRequest(
        ...
        @Schema(description = "CEP (Brazilian postal code) with exactly 8 digits", examples = {"01001000", "19902070", "29050333", "26270040"})
        @NotBlank(message = "This field is mandatory")
